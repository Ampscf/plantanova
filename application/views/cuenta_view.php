				...
				<div class="panel-body" style="padding: 10px 10px 10px 10px;">
					...
					<div class="col-md-6">
						...
						<div class="input-group input-group-lg">
							...
							<input type="text" class="form-control" placeholder="Correo electrónico" name="email" id="email" value="<?php echo $myinfo->mail; ?>">
						</div><!-- End email -->
						...
						<div class="input-group input-group-lg">
							...
							<input type="text" class="form-control" placeholder="Teléfono" name="phone" id="phone" value="<?php echo $myinfo->phone; ?>">
						</div><!-- End phone -->
					...
					<div class="col-md-6">
						<div class="input-group input-group-lg">
							...
							<input type="text" class="form-control" placeholder="Agrícola" name="farm_name" id="farm_name" value="<?php echo $myinfo->farm_name; ?>">
						</div><!-- End farm name -->
						...
						<div class="input-group input-group-lg">
							...
							<input type="text" class="form-control" placeholder="Número" name="addr_number" id="addr_number" value="<?php echo $myinfo->addr_number; ?>">
