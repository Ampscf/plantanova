<div class="row">
	<div class="col-md-8 col-md-offset-2">
		<div class="panel panel-default">
			...
			<?php 
				$attributes = array('id' => 'update_seeds','name'=>'update_seeds');
				echo form_open('seeds/update_seeds/'.$seed->result()[0]->id_seed,$attributes); 
				...
				<div class="panel-body" style="padding: 10px 10px 10px 10px;">
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							...
							<div class="input-group input-group-lg">
								...
								<select class="form-control" name="id_order" id="id_order" onchange="get_order(this.value);">
									<option value="<?php echo $seed->result()[0]->id_order?>" selected><?php echo "Orden ". $seed->result()[0]->id_order;?></option>
									<?php 
							...
							<h3>Nombre</h3>
							<div class="input-group input-group-lg">
								<input type="text" class="form-control" placeholder="Nombre" name="seed_name" id="seed_name" value="<?php echo $seed->result()[0]->seed_name; ?>">
							...
							<h3>Lote</h3>
							<div class="input-group input-group-lg">
								<input type="text" class="form-control" placeholder="Lote" name="batch" id="batch" value="<?php echo $seed->result()[0]->batch; ?>">
							</div><!-- End street -->
						...
						<div class="col-md-6">
							<h3>Cantidad</h3>
							<div class="input-group input-group-lg">
								<input type="text" class="form-control" placeholder="Cantidad" name="volume" id="volume" value="<?php echo $seed->result()[0]->volume; ?>">
							</div><!-- End cp -->
							...
							<div class="input-group input-group-lg">
								<select class="form-control" name="type" id="type">
									<?php if ($seed->result()[0]->type=="Variedad"){?>
