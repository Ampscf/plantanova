...
class Reports extends CI_Controller {
	...
	public function report()
	{
		...
		$objPHPExcel->setActiveSheetIndex(0);
		$cont=1;
		$semillas=$this->model_report->get_seeds();
		...
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2,$cont,"Semilla"); 
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3,$cont,"Lote"); 
		...
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6,$cont,"Tipo");
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7,$cont,"Porcentaje de germinacion");   
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8,$cont,"Marca"); 
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,$cont,"Cultivo"); 
		...
		if(is_array($semillas)){
			foreach ($semillas as $key) {
				...
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2,$cont+1,$key->seed_name);
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3,$cont+1,$key->batch);
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4,$cont+1,$key->volume);
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5,$cont+1,date("d-m-Y",strtotime($key->seeds_date)));
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6,$cont+1,$key->type);
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7,$cont+1,$key->germ_percentage.'%');
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8,$cont+1,$key->mark);
				$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9,$cont+1,$key->plant_name);
				$celdas="A".($cont+1).":J".($cont+1);
